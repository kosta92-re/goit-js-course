(window.webpackJsonp = window.webpackJsonp || []).push([
  [0], {
    ...
    DUDr: function (e, t, n) {
      ...
      e.exports = (i.default || i).template({
        ...
        main: function (e, t, n, i, a) {
          ...
          }) : r) + '" alt="Картофель, запеченный в мундире" class="card__image" />\r\n        <div class="card__content">\r\n            <h2 class="card__name">' + l("function" == typeof (r = null != (r = m(n, "name") || (null != t ? m(t, "name") : t)) ? r : c) ? r.call(o, {
            name: "name",
            hash: {},
            data: a,
            loc: {
          ...
          }) : r) + '</h2>\r\n            <p class="card__price">\r\n                <i class="material-icons">\r\n                    monetization_on\r\n                </i>\r\n                ' + l("function" == typeof (r = null != (r = m(n, "price") || (null != t ? m(t, "price") : t)) ? r : c) ? r.call(o, {
            name: "price",
            hash: {},
            data: a,
            loc: {
          ...
          }) : r) + ' кредитов\r\n            </p>\r\n\r\n            <p class="card__descr">\r\n                ' + l("function" == typeof (r = null != (r = m(n, "description") || (null != t ? m(t, "description") : t)) ? r : c) ? r.call(o, {
            name: "description",
            hash: {},
            data: a,
            loc: {
          ...
          }) : r) + '\r\n            </p>\r\n\r\n            <ul class="tag-list">\r\n' + (null != (s = m(n, "each").call(o, null != t ? m(t, "ingredients") : t, {
            name: "each",
            hash: {},
            fn: e.program(1, a, 0),
            inverse: e.noop,
    ...
    QfWi: function (e, t, n) {
      ...
      i = a.map((function (e) {
        return r()(e)
      })).join(""), o.postFeed.insertAdjacentHTML("beforeend", i);
      var c = "light-theme",
        l = "dark-theme";
      new(function () {
        function e(e, t, n) {
          ...
          }, this.mainTheme = t, this.altTheme = n, this.setLastTheme(), this.init()
        }
        var t = e.prototype;
        return t.init = function () {
          this.refs.el.addEventListener("change", this.changeTheme.bind(this))
        }, t.setLastTheme = function () {
          null !== localStorage.getItem("mainTheme") && (this.refs.el.classList.add(localStorage.getItem("mainTheme")), this.mainTheme = localStorage.getItem("mainTheme"), this.mainTheme === this.altTheme && (this.refs.input.checked = !0), this.altTheme = localStorage.getItem("altTheme"))
        }, t.changeTheme = function () {
          this.refs.el.classList.add(this.altTheme), this.refs.el.classList.remove(this.mainTheme), localStorage.setItem("mainTheme", this.altTheme), localStorage.setItem("altTheme", this.mainTheme), this.altTheme = localStorage.getItem("altTheme"), this.mainTheme = localStorage.getItem("mainTheme")
        }, e
      }())("body", c, l);
      n("OPH6")
    }
...
//# sourceMappingURL=main.e4f344fe49ddc82a1b64.js.map
